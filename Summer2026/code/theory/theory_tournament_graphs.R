...
# Save
#write.csv(df6, "Summer2026/data/isomorphs/nodes6_tournaments.csv", row.names = FALSE)
#saveRDS(reps6, "Summer2026/data/isomorphs/tournaments_6_reps.RDS")
#saveRDS(df6,   "Summer2026/data/isomorphs/tournaments_6_df.RDS")
