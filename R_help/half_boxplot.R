...
GeomBoxJitter <- ggproto("GeomBoxJitter", GeomBoxplot,
                         ...
                         draw_group = function(data, panel_params, coord, fatten = 2,
                           ...
                           ggplot2:::ggname("geom_boxjitter", grid::grobTree(
                             outliers_grob,
                             error_grob,
...
ggplot(ddf, aes(x=group, y=values)) + geom_point()
ggplot(ddf, aes(x=group, y=values)) + geom_boxplot()
ggplot(ddf, aes(x=group, y=values)) + geom_boxplot() + geom_point()
ggplot(ddf, aes(x=group, y=values)) + geom_boxplot() + geom_jitter(width=.1)
ggplot(ddf, aes(x=group, y=values)) + geom_jitter(width=.1)
